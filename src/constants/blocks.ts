export const STATIC_BLOCKS = {
  newsletter: {
    ...
    content: 'Stay updated with our latest news and stories delivered directly to your inbox.',
    defaultSize: { width: 3, height: 1 }
  },
  podcast: {
    id: 'podcast',
    title: 'Latest Podcasts',
    content: 'Listen to our latest episodes discussing current events and in-depth stories.',
    ...
    episodes: [
      {
        ...
        duration: '32:15',
        date: '2024-03-15',
        description: 'Exploring how artificial intelligence is reshaping modern journalism.',
      ...
      },
      {
        ...
        duration: '28:45',
        date: '2024-03-08',
        description: 'Investigating how climate change affects our local communities.',
      ...
      },
      {
        ...
        duration: '35:20',
        date: '2024-03-01',
        description: 'Analyzing the challenges of maintaining democratic values in the era of social media.',
